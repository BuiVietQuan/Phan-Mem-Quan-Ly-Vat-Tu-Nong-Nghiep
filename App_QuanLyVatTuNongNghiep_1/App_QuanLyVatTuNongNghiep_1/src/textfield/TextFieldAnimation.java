...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/textfield/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/textfield/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/textfield/loading.gif"));
